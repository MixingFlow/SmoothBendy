...
internal struct WriteFileOptionsInternal : ISettable, IDisposable
{
	...
	public void Set(WriteFileOptions other)
	{
		if (other != null)
		{
			...
			m_WriteFileDataCallback = ((other.WriteFileDataCallback == null) ? IntPtr.Zero : Marshal.GetFunctionPointerForDelegate(WriteFileDataCallback));
			m_FileTransferProgressCallback = ((other.FileTransferProgressCallback == null) ? IntPtr.Zero : Marshal.GetFunctionPointerForDelegate(FileTransferProgressCallback));
		}
	}
