...
public static class DOTweenModuleAudio
{
	public static Tweener DOFade(this AudioSource target, float endValue, float duration)
	{
		...
		return (Tweener)(object)TweenSettingsExtensions.SetTarget<TweenerCore<float, float, FloatOptions>>(DOTween.To((DOGetter<float>)(() => target.volume), (DOSetter<float>)delegate(float x)
		{
			target.volume = x;
	...
	{
		return (Tweener)(object)TweenSettingsExtensions.SetTarget<TweenerCore<float, float, FloatOptions>>(DOTween.To((DOGetter<float>)(() => target.pitch), (DOSetter<float>)delegate(float x)
		{
			target.pitch = x;
		}, endValue, duration), (object)target);
	}
	...
	{
		return (Tweener)(object)TweenSettingsExtensions.SetTarget<TweenerCore<float, float, FloatOptions>>(DOTween.To((DOGetter<float>)delegate
		{
			float result = default(float);
			target.GetFloat(floatName, ref result);
			return result;
