...
public static class DOTweenModuleUI
{
	public static class Utils
	{
		public static Vector2 SwitchToRectTransform(RectTransform from, RectTransform to)
		{
			...
			float num2 = num + ((Rect)(ref rect2)).xMin;
			Rect rect3 = from.rect;
			float num3 = ((Rect)(ref rect3)).height * 0.5f;
			Rect rect4 = from.rect;
			Vector2 val = default(Vector2);
			((Vector2)(ref val))._002Ector(num2, num3 + ((Rect)(ref rect4)).yMin);
			...
			Rect rect5 = to.rect;
			float num4 = ((Rect)(ref rect5)).width * 0.5f;
			Rect rect6 = to.rect;
			float num5 = num4 + ((Rect)(ref rect6)).xMin;
			Rect rect7 = to.rect;
			float num6 = ((Rect)(ref rect7)).height * 0.5f;
			Rect rect8 = to.rect;
			Vector2 val4 = default(Vector2);
			((Vector2)(ref val4))._002Ector(num5, num6 + ((Rect)(ref rect8)).yMin);
	...
	{
		return (Tweener)(object)TweenSettingsExtensions.SetTarget<TweenerCore<float, float, FloatOptions>>(DOTween.To((DOGetter<float>)(() => target.alpha), (DOSetter<float>)delegate(float x)
		{
			target.alpha = x;
	...
	public static Tweener DOFillAmount(this Image target, float endValue, float duration)
	{
		...
		return (Tweener)(object)TweenSettingsExtensions.SetTarget<TweenerCore<float, float, FloatOptions>>(DOTween.To((DOGetter<float>)(() => target.fillAmount), (DOSetter<float>)delegate(float x)
		{
			target.fillAmount = x;
		}, endValue, duration), (object)target);
	}
	...
	{
		//IL_0025: Unknown result type (might be due to invalid IL or missing references)
		return TweenSettingsExtensions.SetTarget<Tweener>(TweenSettingsExtensions.SetOptions(DOTween.To((DOGetter<Vector2>)(() => new Vector2(target.flexibleWidth, target.flexibleHeight)), (DOSetter<Vector2>)delegate(Vector2 x)
		{
	...
	{
		//IL_0025: Unknown result type (might be due to invalid IL or missing references)
		return TweenSettingsExtensions.SetTarget<Tweener>(TweenSettingsExtensions.SetOptions(DOTween.To((DOGetter<Vector2>)(() => new Vector2(target.minWidth, target.minHeight)), (DOSetter<Vector2>)delegate(Vector2 x)
		{
			target.minWidth = x.x;
	...
	{
		//IL_0025: Unknown result type (might be due to invalid IL or missing references)
		return TweenSettingsExtensions.SetTarget<Tweener>(TweenSettingsExtensions.SetOptions(DOTween.To((DOGetter<Vector2>)(() => new Vector2(target.preferredWidth, target.preferredHeight)), (DOSetter<Vector2>)delegate(Vector2 x)
		{
	...
	{
		//IL_0025: Unknown result type (might be due to invalid IL or missing references)
		return (Tweener)(object)TweenSettingsExtensions.SetTarget<TweenerCore<Color, Color, ColorOptions>>(DOTween.To((DOGetter<Color>)(() => ((Shadow)target).effectColor), (DOSetter<Color>)delegate(Color x)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
	...
	{
		return TweenSettingsExtensions.SetTarget<Tweener>(DOTween.ToAlpha((DOGetter<Color>)(() => ((Shadow)target).effectColor), (DOSetter<Color>)delegate(Color x)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			((Shadow)target).effectColor = x;
		}, endValue, duration), (object)target);
	...
	{
		//IL_0025: Unknown result type (might be due to invalid IL or missing references)
		return (Tweener)(object)TweenSettingsExtensions.SetTarget<TweenerCore<Vector2, Vector2, VectorOptions>>(DOTween.To((DOGetter<Vector2>)(() => ((Shadow)target).effectDistance), (DOSetter<Vector2>)delegate(Vector2 x)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
	...
	{
		//IL_0025: Unknown result type (might be due to invalid IL or missing references)
		return TweenSettingsExtensions.SetTarget<Tweener>(TweenSettingsExtensions.SetOptions(DOTween.To((DOGetter<Vector2>)(() => target.anchoredPosition), (DOSetter<Vector2>)delegate(Vector2 x)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
	...
	public static Tweener DOAnchorPosX(this RectTransform target, float endValue, float duration, bool snapping = false)
	{
		...
		return TweenSettingsExtensions.SetTarget<Tweener>(TweenSettingsExtensions.SetOptions(DOTween.To((DOGetter<Vector2>)(() => target.anchoredPosition), (DOSetter<Vector2>)delegate(Vector2 x)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			target.anchoredPosition = x;
		}, new Vector2(endValue, 0f), duration), (AxisConstraint)2, snapping), (object)target);
	}
	...
	public static Tweener DOAnchorPosY(this RectTransform target, float endValue, float duration, bool snapping = false)
	{
		...
		return TweenSettingsExtensions.SetTarget<Tweener>(TweenSettingsExtensions.SetOptions(DOTween.To((DOGetter<Vector2>)(() => target.anchoredPosition), (DOSetter<Vector2>)delegate(Vector2 x)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			target.anchoredPosition = x;
		}, new Vector2(0f, endValue), duration), (AxisConstraint)4, snapping), (object)target);
	}

	public static Tweener DOAnchorPos3D(this RectTransform target, Vector3 endValue, float duration, bool snapping = false)
	{
		//IL_0025: Unknown result type (might be due to invalid IL or missing references)
		return TweenSettingsExtensions.SetTarget<Tweener>(TweenSettingsExtensions.SetOptions(DOTween.To((DOGetter<Vector3>)(() => target.anchoredPosition3D), (DOSetter<Vector3>)delegate(Vector3 x)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
	...
	public static Tweener DOAnchorPos3DX(this RectTransform target, float endValue, float duration, bool snapping = false)
	{
		...
		return TweenSettingsExtensions.SetTarget<Tweener>(TweenSettingsExtensions.SetOptions(DOTween.To((DOGetter<Vector3>)(() => target.anchoredPosition3D), (DOSetter<Vector3>)delegate(Vector3 x)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			target.anchoredPosition3D = x;
		}, new Vector3(endValue, 0f, 0f), duration), (AxisConstraint)2, snapping), (object)target);
	}
	...
	public static Tweener DOAnchorPos3DY(this RectTransform target, float endValue, float duration, bool snapping = false)
	{
		...
		return TweenSettingsExtensions.SetTarget<Tweener>(TweenSettingsExtensions.SetOptions(DOTween.To((DOGetter<Vector3>)(() => target.anchoredPosition3D), (DOSetter<Vector3>)delegate(Vector3 x)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			target.anchoredPosition3D = x;
		}, new Vector3(0f, endValue, 0f), duration), (AxisConstraint)4, snapping), (object)target);
	}
	...
	public static Tweener DOAnchorPos3DZ(this RectTransform target, float endValue, float duration, bool snapping = false)
	{
		...
		return TweenSettingsExtensions.SetTarget<Tweener>(TweenSettingsExtensions.SetOptions(DOTween.To((DOGetter<Vector3>)(() => target.anchoredPosition3D), (DOSetter<Vector3>)delegate(Vector3 x)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			target.anchoredPosition3D = x;
		}, new Vector3(0f, 0f, endValue), duration), (AxisConstraint)8, snapping), (object)target);
	}

	public static Tweener DOAnchorMax(this RectTransform target, Vector2 endValue, float duration, bool snapping = false)
	{
		//IL_0025: Unknown result type (might be due to invalid IL or missing references)
		return TweenSettingsExtensions.SetTarget<Tweener>(TweenSettingsExtensions.SetOptions(DOTween.To((DOGetter<Vector2>)(() => target.anchorMax), (DOSetter<Vector2>)delegate(Vector2 x)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			target.anchorMax = x;
		}, endValue, duration), snapping), (object)target);
	...
	{
		//IL_0025: Unknown result type (might be due to invalid IL or missing references)
		return TweenSettingsExtensions.SetTarget<Tweener>(TweenSettingsExtensions.SetOptions(DOTween.To((DOGetter<Vector2>)(() => target.anchorMin), (DOSetter<Vector2>)delegate(Vector2 x)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			target.anchorMin = x;
		}, endValue, duration), snapping), (object)target);
	...
	{
		//IL_0025: Unknown result type (might be due to invalid IL or missing references)
		return (Tweener)(object)TweenSettingsExtensions.SetTarget<TweenerCore<Vector2, Vector2, VectorOptions>>(DOTween.To((DOGetter<Vector2>)(() => target.pivot), (DOSetter<Vector2>)delegate(Vector2 x)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			target.pivot = x;
		}, endValue, duration), (object)target);
	...
	{
		//IL_002b: Unknown result type (might be due to invalid IL or missing references)
		return TweenSettingsExtensions.SetTarget<Tweener>(TweenSettingsExtensions.SetOptions(DOTween.To((DOGetter<Vector2>)(() => target.pivot), (DOSetter<Vector2>)delegate(Vector2 x)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			target.pivot = x;
		}, new Vector2(endValue, 0f), duration), (AxisConstraint)2, false), (object)target);
	}
	...
	public static Tweener DOPivotY(this RectTransform target, float endValue, float duration)
	{
		...
		return TweenSettingsExtensions.SetTarget<Tweener>(TweenSettingsExtensions.SetOptions(DOTween.To((DOGetter<Vector2>)(() => target.pivot), (DOSetter<Vector2>)delegate(Vector2 x)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			target.pivot = x;
		}, new Vector2(0f, endValue), duration), (AxisConstraint)4, false), (object)target);
	}

	public static Tweener DOSizeDelta(this RectTransform target, Vector2 endValue, float duration, bool snapping = false)
	{
		//IL_0025: Unknown result type (might be due to invalid IL or missing references)
		return TweenSettingsExtensions.SetTarget<Tweener>(TweenSettingsExtensions.SetOptions(DOTween.To((DOGetter<Vector2>)(() => target.sizeDelta), (DOSetter<Vector2>)delegate(Vector2 x)
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			target.sizeDelta = x;
		}, endValue, duration), snapping), (object)target);
	...
	{
		return TweenSettingsExtensions.SetTarget<Tweener>(TweenSettingsExtensions.SetOptions(DOTween.To((DOGetter<float>)(() => target.value), (DOSetter<float>)delegate(float x)
		{
			target.value = x;
		}, endValue, duration), snapping), (object)target);
	}
	...
	public static Tweener DOText(this Text target, string endValue, float duration, bool richTextEnabled = true, ScrambleMode scrambleMode = (ScrambleMode)0, string scrambleChars = null)
	{
