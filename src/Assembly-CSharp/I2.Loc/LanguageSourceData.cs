...
public class LanguageSourceData
{
	...
	private string GetSourcePlayerPrefName()
	{
		...
		return ((Scene)(ref activeScene)).name + "_" + text;
	}
	...
	public UnityWebRequest Import_Google_CreateWWWcall(bool ForceUpdate, bool justCheck)
	{
		...
		string text2 = string.Format("{0}?key={1}&action=GetLanguageSource&version={2}", LocalizationManager.GetWebServiceURL(this), Google_SpreadsheetKey, (!ForceUpdate) ? Google_LastUpdatedVersion : "0");
		UnityWebRequest val = UnityWebRequest.Get(text2);
