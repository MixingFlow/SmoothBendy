...
public static class LocalizationManager
{
	...
	private static void RegisterSceneSources()
	{
		...
		LanguageSource[] array2 = array;
		foreach (LanguageSource languageSource in array2)
		{
			if (!Sources.Contains(languageSource.mSource))
			{
				if (languageSource.mSource.owner == (Object)null)
				{
					languageSource.mSource.owner = (Object)(object)languageSource;
				}
	...
	private static void RegisterSourceInResources()
	{
		...
		foreach (string name in globalSources)
		{
			...
			if (Object.op_Implicit((Object)(object)asset) && !Sources.Contains(asset.mSource))
			{
				...
				asset.mSource.owner = (Object)(object)asset;
