	...
	public override void DoLocalize(Localize cmp, string mainTranslation, string secondaryTranslation)
	{
		...
		else
		{
			...
			if ((Object)(object)secondaryTranslatedObj2 != (Object)null && (Object)(object)mTarget.fontMaterial != (Object)(object)secondaryTranslatedObj2)
			{
				...
				{
					secondaryTranslatedObj = LocalizeTarget_TextMeshPro_Label.GetTMPFontFromMaterial(cmp, (!secondaryTranslation.EndsWith(((Object)secondaryTranslatedObj2).name, StringComparison.Ordinal)) ? ((Object)secondaryTranslatedObj2).name : secondaryTranslation);
					if ((Object)(object)secondaryTranslatedObj != (Object)null)
					{
						LocalizeTarget_TextMeshPro_Label.SetFont(mTarget, secondaryTranslatedObj);
					}
