...
public class RealTimeTranslation : MonoBehaviour
{
	...
	public void OnGUI()
	{
		GUILayout.Label("Translate:", (GUILayoutOption[])(object)new GUILayoutOption[0]);
		OriginalText = GUILayout.TextArea(OriginalText, (GUILayoutOption[])(object)new GUILayoutOption[1] { GUILayout.Width((float)Screen.width) });
		GUILayout.Space(10f);
		GUILayout.BeginHorizontal((GUILayoutOption[])(object)new GUILayoutOption[0]);
		if (GUILayout.Button("English -> Español", (GUILayoutOption[])(object)new GUILayoutOption[1] { GUILayout.Height(100f) }))
		{
			StartTranslating("en", "es");
		}
		if (GUILayout.Button("Español -> English", (GUILayoutOption[])(object)new GUILayoutOption[1] { GUILayout.Height(100f) }))
		{
		...
		GUILayout.Space(10f);
		GUILayout.BeginHorizontal((GUILayoutOption[])(object)new GUILayoutOption[0]);
		GUILayout.TextArea("Multiple Translation with 1 call:\n'This is an example' -> en,zh\n'Hola' -> en", (GUILayoutOption[])(object)new GUILayoutOption[0]);
		if (GUILayout.Button("Multi Translate", (GUILayoutOption[])(object)new GUILayoutOption[1] { GUILayout.ExpandHeight(true) }))
		{
			ExampleMultiTranslations_Async();
		}
		GUILayout.EndHorizontal();
		GUILayout.TextArea(TranslatedText, (GUILayoutOption[])(object)new GUILayoutOption[1] { GUILayout.Width((float)Screen.width) });
		GUILayout.Space(10f);
		if (IsTranslating)
		{
			GUILayout.Label("Contacting Google....", (GUILayoutOption[])(object)new GUILayoutOption[0]);
		}
	}
	...
	public void ExampleMultiTranslations_Blocking()
	{
		...
		if (GoogleTranslation.ForceTranslate(dictionary))
		{
			...
			Debug.Log((object)GoogleTranslation.GetQueryResult("This is an example", string.Empty, dictionary));
