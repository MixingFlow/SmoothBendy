...
public class InputDevice
{
	...
	private void ProcessLeftStick(ulong updateTick, float deltaTime)
	{
		...
		float num = Utility.ValueFromSides(LeftStickLeft.NextRawValue, LeftStickRight.NextRawValue);
		float num2 = Utility.ValueFromSides(LeftStickDown.NextRawValue, LeftStickUp.NextRawValue, InputManager.InvertYAxis);
		...
		else
		{
			...
			val = LeftStick.DeadZoneFunc(num, num2, lowerDeadZone, upperDeadZone);
		}
		LeftStick.Raw = true;
		LeftStick.UpdateWithAxes(val.x, val.y, updateTick, deltaTime);
		LeftStickX.Raw = true;
		LeftStickX.CommitWithValue(val.x, updateTick, deltaTime);
		LeftStickY.Raw = true;
		LeftStickY.CommitWithValue(val.y, updateTick, deltaTime);
	...
	private void ProcessRightStick(ulong updateTick, float deltaTime)
	{
		//IL_010b: Unknown result type (might be due to invalid IL or missing references)
		//IL_0110: Unknown result type (might be due to invalid IL or missing references)
		float num = Utility.ValueFromSides(RightStickLeft.NextRawValue, RightStickRight.NextRawValue);
		float num2 = Utility.ValueFromSides(RightStickDown.NextRawValue, RightStickUp.NextRawValue, InputManager.InvertYAxis);
		Vector2 val = default(Vector2);
		...
		else
		{
			...
			val = RightStick.DeadZoneFunc(num, num2, lowerDeadZone, upperDeadZone);
		}
		RightStick.Raw = true;
		RightStick.UpdateWithAxes(val.x, val.y, updateTick, deltaTime);
		RightStickX.Raw = true;
		RightStickX.CommitWithValue(val.x, updateTick, deltaTime);
		RightStickY.Raw = true;
		RightStickY.CommitWithValue(val.y, updateTick, deltaTime);
	...
	private void ProcessDPad(ulong updateTick, float deltaTime)
	{
		//IL_010b: Unknown result type (might be due to invalid IL or missing references)
		//IL_0110: Unknown result type (might be due to invalid IL or missing references)
		float num = Utility.ValueFromSides(DPadLeft.NextRawValue, DPadRight.NextRawValue);
		float num2 = Utility.ValueFromSides(DPadDown.NextRawValue, DPadUp.NextRawValue, InputManager.InvertYAxis);
		Vector2 val = default(Vector2);
		...
		else
		{
			...
			val = DPad.DeadZoneFunc(num, num2, lowerDeadZone, upperDeadZone);
		}
		DPad.Raw = true;
		DPad.UpdateWithAxes(val.x, val.y, updateTick, deltaTime);
		DPadX.Raw = true;
		DPadX.CommitWithValue(val.x, updateTick, deltaTime);
		DPadY.Raw = true;
		DPadY.CommitWithValue(val.y, updateTick, deltaTime);
