...
public class NativeInputDeviceManager : InputDeviceManager
{
	...
	public static bool CheckPlatformSupport(ICollection<string> errors)
	{
		...
		if ((int)Application.platform != 1 && (int)Application.platform != 0 && (int)Application.platform != 2 && (int)Application.platform != 7)
		{
			return false;
		}
		try
	...
	internal static bool Enable()
	{
		...
		{
			Debug.LogError((object)("Error enabling NativeInputDeviceManager: " + item));
		}
		return false;
	}
}
