...
public class UnityInputDeviceProfile : UnityInputDeviceProfileBase
{
	...
	protected static InputControlSource MenuKey = new UnityKeyCodeSource((KeyCode)319);

	protected static InputControlSource EscapeKey = new UnityKeyCodeSource((KeyCode)27);
