...
public static class ShaderUtilities
{
	...
	public static void UpdateShaderRatios(Material mat, bool isBold)
	{
		...
		{
			float num13 = mat.GetFloat(ID_UnderlayOffsetX);
			...
			float num17 = (num8 + num5) * (num4 - m_clamp);
			num9 = Mathf.Max(1f, Mathf.Max(Mathf.Abs(num13), Mathf.Abs(num14)) + num15 + num16);
			num3 = ((!flag) ? 1f : (Mathf.Max(0f, num4 - m_clamp - num17) / (num4 * num9)));
