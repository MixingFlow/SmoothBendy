...
public static class TMPro_ExtensionMethods
{
	...
	{
		int instanceID = ((Object)target/*cast due to constrained. prefix*/).GetInstanceID();
		for (int i = 0; i < list.Count; i++)
		{
			if (((Object)list[i]/*cast due to constrained. prefix*/).GetInstanceID() == instanceID)
			{
				return i;
			}
		}
	...
	public static Color32 Tint(this Color32 c1, float tint)
	{
		...
		byte b = (byte)Mathf.Clamp((float)(int)c1.r / 255f * tint * 255f, 0f, 255f);
		byte b2 = (byte)Mathf.Clamp((float)(int)c1.g / 255f * tint * 255f, 0f, 255f);
		byte b3 = (byte)Mathf.Clamp((float)(int)c1.b / 255f * tint * 255f, 0f, 255f);
		byte b4 = (byte)Mathf.Clamp((float)(int)c1.a / 255f * tint * 255f, 0f, 255f);
		return new Color32(b, b2, b3, b4);
	}
